...
target 'MapxusMapSample' do
  ...
  pod 'MapxusBaseSDK', "8.1.1" #:path => '../mapxus-base-sdk-ios'
  pod 'MapxusMapSDK', "8.1.1" #::path => '../mapxus-map-sdk-ios'
  pod 'MapxusVisualSDK', "8.1.1" #::path => '../mapxus-visual-sdk-ios'
  pod 'MapxusComponentKit', "8.1.1" #::path => '../mapxus-component-kit-ios'
