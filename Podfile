...
target 'MapxusMapSample' do
  ...
  pod 'MapxusBaseSDK', '6.11.0'#:path => '../mapxus-base-sdk-ios'
  pod 'MapxusMapSDK', '6.11.0'#:path => '../mapxus-map-sdk-ios'
  pod 'MapxusVisualSDK', '6.11.0'#:path => '../mapxus-visual-sdk-ios'
  pod 'MapxusComponentKit', '6.11.0'#:path => '../mapxus-component-kit-ios'
