//
//  SearchVenueGlobalViewController.m
//  MapxusMapSample
//
//  Created by guochenghao on 2023/6/6.
...
#import "SearchVenueGlobalViewController.h"
#import "SearchBuildingGlobalParamViewController.h"

@interface SearchVenueGlobalViewController ()<MXMVenueSearchDelegate, MGLMapViewDelegate, Param>
@property (nonatomic, strong) MGLMapView *mapView;
@property (nonatomic, strong) MapxusMap *mapxusMap;
@end

@implementation SearchVenueGlobalViewController
...
- (void)completeParamConfiguration:(NSDictionary *)param {
  ...
  MXMVenueGlobalSearchOption *opt = [[MXMVenueGlobalSearchOption alloc] init];
