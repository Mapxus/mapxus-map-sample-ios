//
//  SearchVenueByIDParamViewController.m
//  MapxusMapSample
//
...
@interface SearchVenueByIDParamViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation SearchVenueByIDParamViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = [UIColor whiteColor];
    [self.dataSource addObject:PARAMCONFIGINFO.venueId];
    [self layoutUI];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    VenueIDCell *cell = [tableView dequeueReusableCellWithIdentifier:@"VenueIDCell"];
    [cell refreshData:self.dataSource[indexPath.row]];
    __weak typeof(self) weakSelf = self;
    cell.endEditBlock = ^(VenueIDCell * _Nonnull cell, NSString * _Nullable text) {
...
- (UITableView *)tableVeiw {
    if (!_tableVeiw) {
        ...
        [_tableVeiw registerClass:[VenueIDCell class] forCellReuseIdentifier:@"VenueIDCell"];
    }
    return _tableVeiw;
}
