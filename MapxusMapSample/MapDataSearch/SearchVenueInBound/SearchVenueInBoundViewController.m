...
@interface SearchVenueInBoundViewController () <MGLMapViewDelegate, MXMVenueSearchDelegate, Param>
...
- (void)completeParamConfiguration:(NSDictionary *)param {
  ...
  MXMVenueBboxSearchOption *opt = [[MXMVenueBboxSearchOption alloc] init];
  ...
  api.delegate = self;
  [api searchVenuesInBoundingBox:opt];
}
