...
- (void)changeSortMode:(UIButton *)sender {
    ...
    if (sender.isSelected) {
        [self.sortButton setTitle:@"ActualDistance" forState:UIControlStateNormal];
        self.buildingIDTip.textColor = nil;
        self.ordinalTip.textColor = nil;
        self.buildingIDTextField.enabled = YES;
        self.ordinalTextField.enabled = YES;
    } else {
        [self.sortButton setTitle:@"AbsoluteDistance" forState:UIControlStateNormal];
        self.buildingIDTip.textColor = [UIColor lightGrayColor];
        self.ordinalTip.textColor = [UIColor lightGrayColor];
        self.buildingIDTextField.enabled = NO;
...
- (void)layoutUI {
    ...
    [self.sortTip.topAnchor constraintEqualToAnchor:self.categoryTextField.bottomAnchor constant:moduleSpace].active = YES;
    ...
    [self.buildingIDTip.topAnchor constraintEqualToAnchor:self.sortButton.bottomAnchor constant:moduleSpace].active = YES;
    ...
    [self.ordinalTip.topAnchor constraintEqualToAnchor:self.buildingIDTextField.bottomAnchor constant:moduleSpace].active = YES;
...
- (UIButton *)sortButton {
    if (!_sortButton) {
        ...
        [_sortButton setTitle:@"ActualDistance" forState:UIControlStateNormal];
        [_sortButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        _sortButton.backgroundColor = [UIColor colorWithRed:80/255.0 green:175/255.0 blue:243/255.0 alpha:1.0];
        [_sortButton addTarget:self action:@selector(changeSortMode:) forControlEvents:UIControlEventTouchUpInside];
        _sortButton.layer.cornerRadius = 5;
