...
@interface SearchIntegrateCategoryViewController () <UITableViewDelegate, UITableViewDataSource, MXMSearchDelegate>
...
- (void)onPOICategorySearchDone:(MXMPOICategorySearchRequest *)request response:(MXMPOICategorySearchResponse *)response {
    ...
    [self.datas addObjectsFromArray:response.category];
