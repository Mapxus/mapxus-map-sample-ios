//
//  DrawPolygonWithHolesViewController.m
//  MapxusMapSample
//
...
@interface DrawPolygonWithHolesViewController () <MGLMapViewDelegate>
...
@implementation DrawPolygonWithHolesViewController
...
- (void)viewDidLoad {
    ...
    CLLocationCoordinate2D interCoordinates[] = {
        CLLocationCoordinate2DMake(22.302779, 114.159409),
        CLLocationCoordinate2DMake(22.302436, 114.160199),
        CLLocationCoordinate2DMake(22.302377, 114.161718),
        CLLocationCoordinate2DMake(22.301436, 114.160055),
        CLLocationCoordinate2DMake(22.301420, 114.159335),
        CLLocationCoordinate2DMake(22.302779, 114.159409),
    };
    NSUInteger numberOfInterCoordinates = sizeof(interCoordinates) / sizeof(CLLocationCoordinate2D);
    MGLPolygon *interPolygon = [MGLPolygon polygonWithCoordinates:interCoordinates count:numberOfInterCoordinates];
    ...
    MGLPolygon *polygon = [MGLPolygon polygonWithCoordinates:coordinates count:numberOfCoordinates interiorPolygons:@[interPolygon]];
