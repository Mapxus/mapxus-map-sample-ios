//
//  SearchPOIInBuildingViewController.m
//  MapxusMapSample
//
...
@interface SearchPOIInBuildingViewController () <MGLMapViewDelegate, MXMSearchDelegate, UITextFieldDelegate>
...
@implementation SearchPOIInBuildingViewController
